...
(function () {
  ...
  function wsUrl(base, canal, extra) {
    ...
    /* WebSocket não permite cabeçalho Authorization no navegador; o agente
       aceita o token na query apenas para esta rota WS. */
    try {
      const token = (typeof LS !== 'undefined') ? LS.get('arkher_agent_token', '') : '';
